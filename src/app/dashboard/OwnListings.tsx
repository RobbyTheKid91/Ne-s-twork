...
import { deleteListing, togglePauseListing } from './actions'
...
function ListingCard({ listing, onDeleted, onEdit }: CardProps) {
  ...
  function handleDelete() {
    onDeleted(listing.id) // sofort aus lokalem State entfernen
...
export function OwnListings({ listings: initialListings }: Props) {
  // Lokaler State — optimistische Deletions; useEffect synct wenn Server neue Props liefert
